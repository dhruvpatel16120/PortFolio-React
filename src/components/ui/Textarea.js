...
const Textarea = forwardRef(({ 
  ...
  const baseClasses = 'w-full px-4 py-3 rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 resize-none';
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="relative">
        {Icon && (
          <div className="absolute left-3 top-4 text-lightAccent dark:text-darkAccent">
            <Icon size={20} />
          </div>
        )}
        <textarea
