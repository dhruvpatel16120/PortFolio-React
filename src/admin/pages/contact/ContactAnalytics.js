          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
            ...
            <div className="space-y-4">
              {analytics.responseTimeAnalysis?.map((timeRange) => (
                <div key={timeRange.range} className="flex items-center justify-between">
                  <div className="flex items-center">
                    <HiClock className="w-5 h-5 text-blue-600 mr-3" />
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {analytics.topReferrers?.map((referrer) => (
              <div key={referrer.source} className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
            ...
            <div className="space-y-4">
              {analytics.devices.map((device, index) => (
                <div key={device.type} className="flex items-center justify-between">
                  <div className="flex items-center">
                    {device.type === 'desktop' ? (
                      <HiDesktopComputer className="w-5 h-5 text-blue-600 mr-3" />
                    ) : (
                      <HiDeviceMobile className="w-5 h-5 text-green-600 mr-3" />
                    )}
                    <span className="font-medium text-gray-900 dark:text-white capitalize">
                      {device.type}
                    </span>
            ...
            <div className="space-y-4">
              {analytics.locations.map((location, index) => (
                <div key={location.country} className="flex items-center justify-between">
                  <div className="flex items-center">
                                         <FaMapPin className="w-5 h-5 text-red-600 mr-3" />
                    <span className="font-medium text-gray-900 dark:text-white">
                      {location.country}
                    </span>
                  </div>
